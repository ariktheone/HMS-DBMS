        ...
        return (
            <Grommet theme={theme} full>
                <Box>
                    ...
                    {/* Back Button */}
                    <Box
    margin={{ top: 'medium', align: 'center' }}
    style={{ width: '200px', height: '50px', display: 'flex', justifyContent: 'center', alignItems: 'center' }} // Set your desired width and height here
>
    <Button
        label="Back"
